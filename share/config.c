...
static struct
{
    ...
    { &CONFIG_WIDTH,        "width",        480 },
    { &CONFIG_HEIGHT,       "height",       272 },
    ...
    { &CONFIG_JOYSTICK_BUTTON_R,      "joystick_button_r",      4 },
    { &CONFIG_JOYSTICK_BUTTON_L,      "joystick_button_l",      5 },
    { &CONFIG_JOYSTICK_BUTTON_EXIT,   "joystick_button_exit",   11},
    { &CONFIG_JOYSTICK_CAMERA_1,      "joystick_camera_1",      99}, // unmapped
    { &CONFIG_JOYSTICK_CAMERA_2,      "joystick_camera_2",      99}, // unmapped
    { &CONFIG_JOYSTICK_CAMERA_3,      "joystick_camera_3",      99}, // unmapped
    ...
    { &CONFIG_JOYSTICK_CAMERA_TOGGLE, "joystick_camera_toggle", 10},
    { &CONFIG_JOYSTICK_ROTATE_FAST,   "joystick_rotate_fast",   2 },
